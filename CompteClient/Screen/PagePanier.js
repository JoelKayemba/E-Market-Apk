            ...
            try {
                await new Promise(resolve => setTimeout(resolve, 2000));
                 ...
                 const items = [
                    ...
                    { id: '4', nom: 'sac', prix: '40.00', image: require('../../assets/Images/sac.jpg'), livraison: true, couleur: ['Noir', 'Marron'], taille: ['Petit', 'Moyen', 'Grand'], description: 'Sac en cuir élégant, disponible en plusieurs tailles et couleurs.' },
